    ...
    <form method="POST" action="">
        <div class="noidung_chitiet">
            ...
            <div class="content-wrapper">
                <div class="anh">
                    <img src="../view/admin/ql_sanpham/uploads/<?php echo $row_chitiet['img'] ?>" style="width: 250px; height: 250px; margin-bottom: 10px">
                </div>
                <div class="mota_sp" style="width: fit-content; padding-left: 40px">
                    <span class="label1" style="font-size:18px">Giá bán:</span>
                    <?php
                    if ($row_chitiet['original_price'] > $row_chitiet['selling_price']) {
                        echo '<span class="price1">' . number_format($row_chitiet['selling_price'], 0, ',', '.') . 'vnđ</span>';
                        echo '<span class="or_price" style="text-decoration: line-through; margin-left: 10px; color: #0000">' . number_format($row_chitiet['original_price'], 0, ',', '.') . 'vnđ</span>';
                    } else {
                        echo '<span class="price">' . number_format($row_chitiet['selling_price'], 0, ',', '.') . 'vnđ</span>';
                    }
                    ?><br>
                    <p style="line-height: 0.2; color: black; font-weight:bold;width: fit-content;font-size:18px">Mô tả: </p>
                    <div class="descr1"><?php echo $row_chitiet['small_descr'] ?></div>
