    ...
    <div class="form">
        <form method="post">
            ...
            <div class = "input-icon">
                <input type="password" id="password" name="new_password" placeholder="Mật khẩu mới" required>
            ...
            <br>
            <div class = "input-icon">
                <input type="password" id="re_enter_password" name="confirm_password" placeholder="Nhập lại mật khẩu mới" required>
