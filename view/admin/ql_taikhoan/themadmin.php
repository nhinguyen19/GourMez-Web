<?php
        ...
        $err=array();
        if(isset($_POST['themadmin']) && ($_POST['themadmin'])=='Thêm')
        {
            include('../../model/xuly_themadmin.php');
        ...
        <link rel="stylesheet" href="ql_taikhoan/themadmin.css">
            ...
            <div class="form">
                ...
                <form class="bang-dk"  method="Post">                
                    ...
                    <div class="has-error">
                        ...
                        <!-- dangky button -->
                    <input class="dk-bt" type="submit" id="dangky" name="themadmin" value="Thêm">
                    <?php
                        if(isset($errors))
                        {
                            if (count($errors) > 0) {
