...
<div class="insert">
    <table>
        ...
        <tr>
            ...
            <td style="text-align: center"><img src="ql_tintuc/<?php echo $row['img_title'] ?>" width="100" height="100"></td>
            <td style="text-align: center"><?php echo $row['title'] ?></td>
            <td style="text-align: center"><?php echo $row['link'] ?></td>
            <td style="text-align: center; width: 90px">
                <button> <a style="text-decoration: none;color: inherit;" href="../admin/tranghienthi.php?quanly=suatintuc&tintucId=<?php echo $row['tintuc_id'] ?>">Sửa</a> </button>    
                <button> <a style="text-decoration: none;color: inherit;" href="../admin/tranghienthi.php?quanly=xoatintuc&tintucId=<?php echo $row['tintuc_id'] ?>">Xóa</a> </button>    
        ...
        <tr>
            <td style="text-align: center" colspan="8">
                <form action="../admin/tranghienthi.php?quanly=themtintuc" method="post">
                    <input type="submit" value="Thêm tin tức" style= " background-color: #F5EAD7; border: 0.5px solid black;font-family: 'Lalezar'; color: #E26A2C">
                </form>
            </td>
        </tr>
    </table>
