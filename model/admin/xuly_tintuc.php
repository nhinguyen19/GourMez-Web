<?php
    function themTinTuc()
    {
        ...
        if (isset($_POST['themTinTuc'])) {
            ...
            if($count > 0) {
                ...
                $sql_them = "INSERT INTO tintuc(title, link ,img_title) VALUES ('$title','$link', '$hinhanh')";
    ...
    function suaTinTuc()
    {
        ...
        if(isset($_POST['suaTinTuc'])) 
        {
            ...
            if($_FILES['hinhanh'])
            {
                $sql_sua = "UPDATE tintuc SET title = '$title', link = '$link',img_title='$hinhanh' WHERE tintuc_id = '$tintucId'";
                move_uploaded_file($hinhanh_tmp,'../../view/admin/ql_tintuc/'.$hinhanh); 
            }
            else{
                $sql_sua = "UPDATE tintuc SET title = '$title', link = '$link' WHERE tintuc_id = '$tintucId'";
            }
